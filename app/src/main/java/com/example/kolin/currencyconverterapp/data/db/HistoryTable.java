...
public class HistoryTable {
    ...
    private static final String CURRENCY_FROM = "currency_from";
    private static final String CURRENCY_TO = "currency_to";
    ...
    public static String selectHistory(String currencyName) {
        return "SELECT * FROM " + TABLE_NAME
                + " WHERE " + HistoryTable.CURRENCY_FROM + " = '" + currencyName + "'"
                + " OR " + HistoryTable.CURRENCY_TO + " = '"+ currencyName + "'"
                + " ORDER BY " + TIME + " DESC";
    }
